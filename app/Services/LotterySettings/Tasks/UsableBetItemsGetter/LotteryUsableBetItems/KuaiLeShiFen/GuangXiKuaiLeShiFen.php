    ...
    protected static $items = [
        ...
        BetType::NORMAL_TYPE_CODE => [
            '平码一|平码二|平码三|平码四|特码' => [
                ...
                '红|绿|蓝' => [
                    'odds' => [LotteryBetType::X_PLAY_FACE => 1.65, LotteryBetType::Y_PLAY_FACE => 2.78],
                    'number_limit' => [0, 2],
                    'money_limit' => [
                        LotteryBetType::X_PLAY_FACE => [
                            self::X_PLAY_FACE_MUST_MORE_THAN_MONEY_DEFAULT, self::X_PLAY_FACE_MUST_LESS_MONEY_DEFAULT
                ...
                '福|禄|寿|喜' => [
                    'odds' => [LotteryBetType::X_PLAY_FACE => 2.5, LotteryBetType::Y_PLAY_FACE => 3.9],
                    'number_limit' => [0, 2],
                    'money_limit' => [
                        LotteryBetType::X_PLAY_FACE => [
                            self::X_PLAY_FACE_MUST_MORE_THAN_MONEY_DEFAULT, self::X_PLAY_FACE_MUST_LESS_MONEY_DEFAULT
        ...
        BetType::XINGYUN_TYPE_CODE => [
            '平码一|平码二|平码三|平码四|特码' => [
                '号码' => [
                    ...
                    'odds' => [LotteryBetType::X_PLAY_FACE => 15, LotteryBetType::Y_PLAY_FACE => 20.47],
                    'number_limit' => [0, 2],
                    'money_limit' => [
                        LotteryBetType::X_PLAY_FACE => [
                            self::X_PLAY_FACE_MUST_MORE_THAN_MONEY_DEFAULT, self::X_PLAY_FACE_MUST_LESS_MONEY_DEFAULT
